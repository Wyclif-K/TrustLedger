...
export function Badge({ children, variant = 'default', className = '' }) {
  const v = { default:'bg-surface-100 text-surface-600', active:'bg-emerald-50 text-emerald-700 border border-emerald-200', pending:'bg-amber-50 text-amber-700 border border-amber-200', approved:'bg-blue-50 text-blue-700 border border-blue-200', disbursed:'bg-violet-50 text-violet-700 border border-violet-200', repaid:'bg-emerald-50 text-emerald-700 border border-emerald-200', rejected:'bg-red-50 text-red-700 border border-red-200', suspended:'bg-orange-50 text-orange-700 border border-orange-200' }
...
export function Alert({ type = 'info', children, onClose, className = '' }) {
  const s = { info:{cls:'bg-blue-50 border-blue-200 text-blue-800',Icon:Info}, success:{cls:'bg-emerald-50 border-emerald-200 text-emerald-800',Icon:CheckCircle2}, error:{cls:'bg-red-50 border-red-200 text-red-800',Icon:XCircle}, warning:{cls:'bg-amber-50 border-amber-200 text-amber-800',Icon:AlertCircle} }
...
export function StatCard({ label, value, sub, icon: Icon, trend, color = 'brand', className = '' }) {
  const colors = { brand:'bg-brand-50 text-brand-600', emerald:'bg-emerald-50 text-emerald-600', amber:'bg-amber-50 text-amber-600', violet:'bg-violet-50 text-violet-600', red:'bg-red-50 text-red-600', blue:'bg-blue-50 text-blue-600' }
  return (
